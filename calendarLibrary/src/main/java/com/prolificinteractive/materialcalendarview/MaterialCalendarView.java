...
public class MaterialCalendarView extends ViewGroup {
    ...
    private final OnClickListener onClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            if (v == buttonFuture && v.isEnabled()) {
                pager.setCurrentItem(pager.getCurrentItem() + 1, true);
            } else if (v == buttonPast && v.isEnabled()) {
                pager.setCurrentItem(pager.getCurrentItem() - 1, true);
            }
        }
    };
    ...
    public MaterialCalendarView(Context context, AttributeSet attrs) {
        ...
        tvLeftTop = content.findViewById(R.id.tv_left_top);
        tvRightTop = content.findViewById(R.id.tv_right_top);
     ...
     * 返回左边控制月份变化的按钮
     */
    public ImageView getButtonPast() {
        return buttonPast;
    }
     ...
     * 返回左边控制月份变化的按钮
     */
    public ImageView getButtonFuture() {
        return buttonFuture;
    }
     ...
     * 设置日历 今天 文字 的颜色
     */
    public void setTodayTextColor(@ColorRes int color) {
    ...
    public void setLeftArrowVisibility(int visibility) {
        buttonPast.setVisibility(visibility);
    }
     ...
     * @param text 文本
     */
    public void setTvLeftTopText(CharSequence text) {
        tvLeftTop.setText(text);
    }
     ...
     * @param textId 文本id
     */
    public void setTvLeftTopText(@StringRes int textId) {
        tvLeftTop.setText(textId);
    }
     ...
     * @param text 文本
     */
    public void setTvRightTopText(String text) {
        tvRightTop.setText(text);
    }
     ...
     * @param textId 文本id
     */
    public void setTvRightTopText(@StringRes int textId) {
    ...
    public void setTvLeftTopClickListener(OnClickListener l) {
        tvLeftTop.setOnClickListener(v -> {
    ...
    public void setTvRightTopClickListener(OnClickListener l) {
        tvRightTop.setOnClickListener(v -> {
    ...
    public void setRightArrowVisibility(int visibility) {
        buttonFuture.setVisibility(visibility);
    }
